...
<div>
    ...
    <input  class='radiob' type="city"  id="inputCity" 
    aria-describedby="cityHelp" placeholder="Enter city">
    
  </div>
<div class='radiob'>
  <input class='radiob' type="radio" name="eR" id="exampleRadios1" 
...
<div class='radiob'>
  <input class='radiob' type="radio" name="eR"
   id="exampleRadios1" value="Celsius: ">
  <label  for="exampleRadios1">
    Celsius
  </label>
</div>
